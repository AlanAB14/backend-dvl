...
const {
  ...
  SSH_PASSWORD,
  LOCAL_PORT,
  DB_CONNECT_TIMEOUT = 10000,  // Tiempo de espera para conectar (en milisegundos, 10 segundos)
} = require('./config.js');
    ...
    sshClient.forwardOut(
      ...
      (err, stream) => {
        ...
        pool = createPool({
          ...
          port: LOCAL_PORT,
          stream: stream,
          connectTimeout: DB_CONNECT_TIMEOUT,  // Tiempo de espera para conectar
          waitForConnections: true, // En caso de que el pool se quede sin conexiones, esperar por una disponible
